...
export const appStrings = {
  en: {
    ...
    assistant: {
      ...
      geminiApiKeyRole: "Autocomplete with Gemini 3.8 Flash. Saving a key makes Gemini the autocomplete provider. API usage is billed by Google.",
      geminiKeySaveFailed: "Could not save the Gemini key. Try again.",
  ...
  es: {
    ...
    assistant: {
      ...
      geminiApiKeyRole: "Autocompletar con Gemini 3.8 Flash. Guardar una clave activa Gemini para autocompletar. Google cobra el uso de la API.",
      geminiKeySaveFailed: "No se pudo guardar la clave Gemini. Intenta de nuevo.",
