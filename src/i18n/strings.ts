...
export const appStrings = {
  en: {
    ...
    writingAssists: {
      ...
      aiIncludedNote: "Free, with a daily limit",
      useMyKey: "Use my key",
      groqKeyRow: "Groq key",
      groqKey: "Groq API key",
      groqKeyPlaceholder: "Paste your Groq API key",
      groqKeyHint: "Goes straight to Groq, with no daily limit from Iliad.",
      keySave: "Save",
      keyCancel: "Cancel",
      keyRemove: "Remove",
      keyGet: "Get a key",
      keyChange: "Change",
      keySaved: (last4: string) => `••••${last4}`,
      keyChecking: "Checking…",
      keyRejected: "Groq didn't accept this key.",
      keyUnreachable: "Couldn't reach Groq to check the key. Try again.",
      keyInvalidShape: "That doesn't look like a Groq API key.",
      keySaveFailed: "Could not save the key. Try again.",
      keyUnreadableNote: "Re-enter your key",
    ...
    editor: {
      ...
      aiNotices: {
        freeExhausted: (time: string) => `Today's free AI has run out. It's back at ${time}.`,
        freePaused: "Free AI is paused right now.",
        clientOutdated: "Update Iliad to keep using free AI.",
        freeUnreachable: "Free AI isn't reachable. Check your connection.",
        freeBusy: "Free AI is busy. Try again shortly.",
        ownKeyUnreachable: "Couldn't reach Groq. Check your connection.",
        ownKeyRejected: "Groq rejected your key. Check it in Writing assists.",
        ownKeyRateLimited: "Your Groq key hit its rate limit. Try again shortly.",
        keyUnreadable: "Re-enter your Groq key in Writing assists.",
        useMyKey: "Use my key",
  ...
  es: {
    ...
    writingAssists: {
      ...
      aiIncludedNote: "Gratis, con un límite diario",
      useMyKey: "Usar mi clave",
      groqKeyRow: "Clave de Groq",
      groqKey: "Clave API de Groq",
      groqKeyPlaceholder: "Pega tu clave API de Groq",
      groqKeyHint: "Va directo a Groq, sin límite diario de Iliad.",
      keySave: "Guardar",
      keyCancel: "Cancelar",
      keyRemove: "Quitar",
      keyGet: "Obtener una clave",
      keyChange: "Cambiar",
      keySaved: (last4: string) => `••••${last4}`,
      keyChecking: "Comprobando…",
      keyRejected: "Groq no aceptó esta clave.",
      keyUnreachable: "No se pudo contactar a Groq para comprobar la clave. Intenta de nuevo.",
      keyInvalidShape: "Eso no parece una clave API de Groq.",
      keySaveFailed: "No se pudo guardar la clave. Intenta de nuevo.",
      keyUnreadableNote: "Vuelve a ingresar tu clave",
    ...
    editor: {
      ...
      aiNotices: {
        // "a la 1:00" is singular in Spanish; every other hour is "a las".
        freeExhausted: (time: string) => `La IA gratis de hoy se agotó. Vuelve ${/^0?1\D/.test(time) ? "a la" : "a las"} ${time}.`,
        freePaused: "La IA gratis está en pausa por ahora.",
        clientOutdated: "Actualiza Iliad para seguir usando la IA gratis.",
        freeUnreachable: "No se pudo conectar con la IA gratis. Revisa tu conexión.",
        freeBusy: "La IA gratis está ocupada. Intenta de nuevo en un momento.",
        ownKeyUnreachable: "No se pudo conectar con Groq. Revisa tu conexión.",
        ownKeyRejected: "Groq rechazó tu clave. Revísala en Ayudas de escritura.",
        ownKeyRateLimited: "Tu clave de Groq llegó a su límite. Intenta de nuevo en un momento.",
        keyUnreadable: "Vuelve a ingresar tu clave de Groq en Ayudas de escritura.",
        useMyKey: "Usar mi clave",
