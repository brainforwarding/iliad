...
export const appStrings = {
  en: {
    ...
    language: {
      ...
      selectWorkspaceRoot: "Select workspace root",
      workspaceRootSelected: "New files will be created at the workspace root.",
  ...
  es: {
    ...
    sidebar: {
      ...
      selectWorkspaceRoot: "Seleccionar raíz del espacio",
      workspaceRootSelected: "Los archivos nuevos se crearán en la raíz del espacio.",
